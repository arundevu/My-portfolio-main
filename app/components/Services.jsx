    ...
    return (
        <motion.div
            ...
            <motion.p
                ...
                Frontend & Mobile Developer based in Chennai with 4+ years of experience specializing in React Native, React.js, and Angular, building scalable, high-performance applications with modern architectures.</motion.p>
            <motion.div
                initial={{ opacity: 0 }}
                whileInView={{ opacity: 1 }}
